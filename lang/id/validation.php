...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Baris berikut berisi pesan error default yang digunakan oleh kelas
    | validator. Beberapa aturan memiliki banyak versi seperti aturan
    | ukuran (size). Anda bebas mengubah tiap pesan ini sesuai kebutuhan.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Bahasa Pesan Validasi Khusus
    |--------------------------------------------------------------------------
    |
    | Di sini Anda dapat menentukan pesan validasi khusus untuk atribut
    | menggunakan konvensi "attribute.rule" agar mudah menentukan baris
    | pesan spesifik untuk aturan atribut yang diberikan.
    |
    */
    ...
    | dengan sesuatu yang lebih ramah-baca, mis. "email_address" -> "Alamat Email".
    | Field spesifik SI-PPG mengikuti istilah domain di SRS/UCIC.
    |
    */
    ...
    'attributes' => [
        ...
        'password_konfirmasi' => 'konfirmasi password',
        'nomor_hp' => 'nomor HP',
