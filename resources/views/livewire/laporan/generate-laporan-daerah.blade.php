<div>
    <x-page-header title="Laporan Bulanan Daerah" description="Agregasi otomatis dari laporan Desa yang sudah final" />
    ...
    <div class="card overflow-x-auto p-0">
        <table class="data-table">
            ...
            <tbody>
                ...
                @empty
                    <tr><td colspan="5"><x-empty-state title="Belum ada Laporan Bulanan Daerah" icon="file-text" /></td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
    ...
    <div class="mt-4">
        <a href="{{ route('laporan.telusur') }}" class="text-sm text-brand-primary hover:underline">
            Lihat laporan Desa/Kelompok individual di daerah ini →
        </a>
    </div>
</div>
