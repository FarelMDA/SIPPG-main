<div>
    <x-page-header title="Laporan Bulanan" description="Generate, tinjau, dan finalisasi laporan bulanan Kelompok" />
    ...
    <div class="card overflow-x-auto p-0">
        <table class="data-table">
            ...
            <tbody>
                ...
                @empty
                    <tr><td colspan="5"><x-empty-state title="Belum ada Laporan Bulanan" icon="file-text" /></td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
